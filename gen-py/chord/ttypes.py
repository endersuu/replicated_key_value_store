...
class ClientRequest(object):
    ...
    def __init__(self, constLevel=None, kv=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.STRING:
                    self.constLevel = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
    ...
    def write(self, oprot):
        ...
        if self.constLevel is not None:
            oprot.writeFieldBegin('constLevel', TType.STRING, 1)
            oprot.writeString(self.constLevel.encode('utf-8') if sys.version_info[0] == 2 else self.constLevel)
            oprot.writeFieldEnd()
        if self.kv is not None:
            oprot.writeFieldBegin('kv', TType.STRUCT, 2)
            self.kv.write(oprot)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class ServerResponse(object):
    ...
    def __init__(self, status=None, kv=None,):
        self.status = status
        self.kv = kv
...
ClientRequest.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'constLevel', 'UTF8', None, ),  # 1
    (2, TType.STRUCT, 'kv', [KV, None], None, ),  # 2
)
